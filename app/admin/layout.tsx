  ...
  return (
    <div className="bg-surface text-on-surface font-body-md antialiased overflow-x-clip min-h-screen flex w-full">
      ...
      <div className="flex-1 min-w-0 ml-0 md:ml-[260px] flex flex-col min-h-screen">
        {/* TopNavBar */}
        <header className="flex justify-between items-center px-margin-mobile md:px-margin-desktop h-[calc(4rem+env(safe-area-inset-top))] pt-[env(safe-area-inset-top)] bg-surface/80 backdrop-blur-xl border-b border-outline-variant/50 shadow-sm sticky top-0 z-40 w-full">
